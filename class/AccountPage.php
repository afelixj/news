...
Class AccountPage 
{
    ...
    public function jnews_user_role_capabilitiies(){
        ...
        } else if (isset($theme_mods['jnews_capabilities_contributor_upload_library']) && !$theme_mods['jnews_capabilities_contributor_upload_library'] ) {
            $subscriber = get_role('contributor');
        ...
        if ( isset($theme_mods['jnews_capabilities_subscriber_upload_library']) && $theme_mods['jnews_capabilities_subscriber_upload_library'] )
        {
            ...
            $subscriber->add_cap('upload_files');
        } else if (isset($theme_mods['jnews_capabilities_subscriber_upload_library']) && !$theme_mods['jnews_capabilities_subscriber_upload_library'] ) {
            $subscriber = get_role('subscriber');
            $subscriber->remove_cap('upload_files');
        }
    }
